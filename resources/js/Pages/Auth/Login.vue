        ...
        <div class="container mx-auto my-auto lg:my-16 px-3 lg:px-16 lg:flex lg:max-w-[70rem]">
            <div
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-sm text-gray-500 self-start truncate">Welcome back, please login to your account</p>
                </div>
                <div class="py-1.5 flex flex-col space-y-2">
                    ...
                    <Button class="!mt-4 w-full bg-primary-800" label="Login" @click="form.post('/login')"/>
                    <div class="flex space-x-1 items-center font-semibold">
                        <span class="text-gray-500">Not registered yet?</span>
                        <InertiaLink :href="route('register.index')">
                            <span class="text-primary-800 hover:text-primary-900">Create an account</span>
                        </InertiaLink>
                    </div>
                </div>
            </div>
            <div class="hidden lg:block w-[30rem] h-full relative rounded-r-md overflow-hidden">
                <img alt="Login Banner" class="absolute w-full h-full block object-cover object-bottom"
                     src="/images/photo-1495640388908-05fa85288e61.jpeg"/>
            </div>
        </div>
    </section>
</template>
