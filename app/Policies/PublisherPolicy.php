...
class PublisherPolicy
{
    ...
    public function create(User $user): Response
    {
        return $user->isAdministrator() ?
            Response::allow() :
            Response::deny('You are not authorized to create a publisher.');
    }
    ...
    public function update(User $user, Publisher $publisher): Response
    {
        return $user->isAdministrator() ?
            Response::allow() :
            Response::deny('You are not authorized to update this publisher.');
    }
    ...
    public function deleteMany(User $user): Response
    {
        return $user->isAdministrator() ?
            Response::allow() :
            Response::deny('You are not authorized to delete publishers.');
    }
